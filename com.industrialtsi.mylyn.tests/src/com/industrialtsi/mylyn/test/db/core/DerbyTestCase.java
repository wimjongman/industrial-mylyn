 ...
 */
public abstract class DerbyTestCase extends TestCase {
	...
	protected static final String IBATIS_REPOSITORY_URL = (null != System.getProperty("IBATIS_REPOSITORY_URL")) ? System
			...
			: "jdbc:derby://localhost:1527//Users/maarten/Desktop/tasks/MylynTestDB;create=true";
	 ...
	 * @param name
	 */
	public DerbyTestCase(String name) {
		super(name);
	}
