...
public class CoreLogger {
	...
	public static IStatus createStatus(int severity, int code, String message, Throwable exception) {
		return new Status(severity, IndustrialCore.PLUGIN_ID, code, message, exception);
	}

	public static IStatus createStatus(int severity, String message, Throwable exception) {
		return new Status(severity, IndustrialCore.PLUGIN_ID, message, exception);
	}

	public static IStatus createStatus(int severity, Throwable exception) {
		return new Status(severity, IndustrialCore.PLUGIN_ID, exception.getMessage(), exception);
	}
